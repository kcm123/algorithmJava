...
//    [70, 50, 80, 50]	100	3
//    [70, 80, 50]	100	3
public class Q4_Lifeboat { // Level2_구명보트
    ...
    public static int solution(int[] people, int limit) {
        ...
        Collections.sort(list, (a, b) -> {
            return -Integer.compare(a, b); // 역순 -1
        });
        Object obj = Collections.binarySearch(list, limit);
        return answer;
        // myCode_30점_실패
//        int answer = 0;
//        int[] boat = new int[people.length];
//        Arrays.sort(people);
//        while(Arrays.stream(boat).min().getAsInt() == 0){
