...
//    meet each other. Then only one fish can stay alive − the larger fish eats the smaller one.
...
//    Finally, it meets fish number 4 and is eaten by it. The remaining two fish, number 0 and 4, never meet and
